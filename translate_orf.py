...
def translate_first_orf(sequence, start_codons, stop_codons, genetic_code):
...
def main():
    ...
    orf = translate_first_orf(sequence = sequence,
            start_codons = args.start_codon,
            stop_codons = args.stop_codon, genetic_code = genetic_code)
    sys.stdout.write('{}\n'.format(orf))
